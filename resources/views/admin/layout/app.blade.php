...
<body>
	...
	<div class="wrapper">
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">News Portal Dashboard</span>
        </a>
              ...
              <i class="align-middle" data-feather="sliders"></i> <span class="align-middle">Dashboard</span>
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="{{route('subscriber.message')}}">
          ...
          <i class="hamburger align-self-center"></i>
                ...
                <img src="{{asset('img/avatars/avatar.jpg')}}" class="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span class="text-dark">Charles Hall</span>
							...
							<div class="dropdown-menu dropdown-menu-end">
								...
								<a class="dropdown-item" href="{{route('home')}}"><i class="align-middle me-1" data-feather="pie-chart"></i> Home Page</a>
