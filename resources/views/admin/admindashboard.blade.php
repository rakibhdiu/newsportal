	...
	<div class="wrapper">
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">AdminKit</span>
              ...
              <i class="align-middle" data-feather="user"></i> <span class="align-middle">Add News</span>
            </a>
					</li>

					<li class="sidebar-item">
						<a class="sidebar-link" href="pages-sign-in.html">
              <i class="align-middle" data-feather="log-in"></i> <span class="align-middle">Show News</span>
            </a>
					</li>

					<li class="sidebar-item">
						<a class="sidebar-link" href="pages-sign-up.html">
              <i class="align-middle" data-feather="user-plus"></i> <span class="align-middle">Show subscriber</span>
            </a>
					</li>
                ...
                <div class="container-fluid p-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$news->title}}</td>
                           <td> <img width="200px" src="{{asset('upload/images/' .$news->image)}}" alt="Image"></td>
                            <td>{{$news->short_p}}</td>
                            <td>{{$news->description}}</td>
                            <td>
								
								<a type="button" href="{{ route('edit', $news->id) }}">Edit</a>
							</td>
                          </tr> 
                        @endforeach
